...
# TODO the methods used here are pretty dumb, improve this in the future!
import numpy as np
import math
...
def export_np_array_as_png(inputArray: np.ndarray, normalizer: float, filePathName: Path) -> float:
    '''
    ...
    def _numpy_layer_to_rgba_array(layer: np.ndarray, normalizer: float) -> np.ndarray:
        ...
        if layer.ndim == 1:
            ...
            # Yes I am using for loops. Bite me # Much later note - I'm an idiot and this is stupid. However this technically works so I am leaving it for now. #TODO
            for x in range(lenX):
